import{x4 as ee,IS as te,IT as ie,Hp as re,Hn as ae,IU as se,IV as oe,Hs as o,IL as ne,I0 as ce,IK as le,Hr as _,IW as pe,IX as de,I4 as j,Hq as he,Ht as ve,Hu as ue,Ip as me,Hw as fe,IY as N,IZ as E,I_ as ge,I$ as Se,I5 as Pe,jX as ye,Hy as we,jZ as _e,Hz as ze,_ as xe,HA as L,HB as R,HC as $e,HD as U,HE as M,I7 as be,HG as Te,HH as Ve,HI as ke,HK as V,HL as Oe,J0 as De,J1 as B,J2 as J,J3 as We,J4 as Ce,J5 as Le,O as c,T as Me,HM as Ie,HN as d,fa as He,I8 as Ae,J6 as q,ri as Fe,IB as je,J7 as Ne,HQ as Ee,cj as Y,l8 as Re,fw as G,cv as K,J8 as Ue}from"./index-2nRREEUn.js";function Q(t){const e=new ee,{space:r,anchor:i,hasTip:P,hasScreenSizePerspective:z}=t,u=r===2,g=r===1;e.include(te,t),e.include(ie,t),e.include(re,t);const{vertex:a,fragment:S,varyings:y}=e;ae(a,t),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new se("nearFar",({camera:p})=>p.nearFar),new oe("viewport",({camera:p})=>p.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
...
}`),P&&(e.include(E),S.constants.add("relativeMarkerSize","float",ge/N).constants.add("relativeTipLineWidth","float",Se).code.add(o`

import{JB as Pe,Jx as be,K0 as we,Hv as f,IM as w,JD as Ve,Hw as W,Hs as r,fm as z,x4 as Y,JA as De,Ip as C,fL as ee,gG as R,he as F,K1 as xe,gc as te,IK as ie,I2 as M,fw as m,fM as v,K2 as ne,zc as se,cv as o,mF as ae,hd as Ee,hy as ye,gF as Le,ck as re,gi as le,hb as Se,Jy as Ce,xi as Me,I0 as Ae,IU as $e,Hr as B,fy as Re,Hy as oe,Hz as ce,_ as he,p0 as Te,fK as G,hz as q,O as c,T as j,jZ as de,jX as pe,cp as Ie,cj as I,lR as Oe,Ib as qe,lW as Ue,K3 as ze,HN as D,JH as je,JI as K,K4 as Ne,nm as He,K5 as T,K6 as We,ht as Fe,uy as Be,hv as Ge,hw as Ke,hx as Je,hA as ke,Q as A,K7 as Xe,pz as J}from"./index-CtxjX9ju.js";import{t as Qe}from"./VisualElement-sZWxJJHG.js";function ue(t,e){const n=t.fragment;n.include(Pe),t.include(be),n.include(we),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new W("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
}`)}const N=z(6);function fe(t){const e=new Y;e.include(De),e.include(ue,t);const n=e.fragment;if(t.lineVerticalPlaneEnabled||t.heightManifoldEnabled)if(n.uniforms.add(new f("maxPixelDistance",(i,s)=>t.heightManifoldEnabled?2*s.camera.computeScreenPixelSizeAt(i.heightManifoldTarget):2*s.camera.computeScreenPixelSizeAt(i.lineVerticalPlaneSegment.origin))),n.code.add(r`float planeDistancePixels(vec4 plane, vec3 pos) {

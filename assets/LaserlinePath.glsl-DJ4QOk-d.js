import{JB as Pe,Jx as be,K0 as we,Hv as f,IM as w,JD as Ve,Hw as W,Hs as r,f0 as j,x4 as Y,JA as De,Ip as C,fp as ee,gk as R,gU as F,K1 as xe,fS as te,IK as ie,I2 as M,fa as m,fq as v,K2 as ne,zc as se,ce as o,mC as ae,gT as Ee,hc as ye,gj as Le,c3 as re,fY as le,gR as Se,Jy as Ce,xi as Me,I0 as Ae,IU as $e,Hr as B,fc as Re,Hy as oe,Hz as ce,_ as he,p0 as Te,fo as G,hd as q,m as c,o as z,jZ as de,jX as pe,c8 as Ie,c2 as I,lR as Oe,Ib as qe,lW as Ue,K3 as je,HN as D,JH as ze,JI as K,K4 as Ne,nm as He,K5 as T,K6 as We,h7 as Fe,uy as Be,h9 as Ge,ha as Ke,hb as Je,he as ke,n as A,K7 as Xe,pz as J}from"./index-1HAoSIjh.js";import{t as Ze}from"./VisualElement-JxsACZSt.js";function ue(t,e){const n=t.fragment;n.include(Pe),t.include(be),n.include(we),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new W("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
}`)}const N=j(6);function fe(t){const e=new Y;e.include(De),e.include(ue,t);const n=e.fragment;if(t.lineVerticalPlaneEnabled||t.heightManifoldEnabled)if(n.uniforms.add(new f("maxPixelDistance",(i,s)=>t.heightManifoldEnabled?2*s.camera.computeScreenPixelSizeAt(i.heightManifoldTarget):2*s.camera.computeScreenPixelSizeAt(i.lineVerticalPlaneSegment.origin))),n.code.add(r`float planeDistancePixels(vec4 plane, vec3 pos) {
